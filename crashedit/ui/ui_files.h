...
/* Browse for file starting at start_dir (or CWD if NULL), fills out_path (0=ok, -1=cancel, -2=error) */
...
/* Same as ui_files_pick but shows editable filename field for save-as, init_name pre-fills name field (may be NULL) */
